...
| `bit_bag.sylius_mollie_plugin.action.state_machine.transition.state_machine_transition`                   | `sylius_mollie.payum.action.state_machine.transition.state_machine_transition`            |
...
`@SyliusAdmin/PaymentMethod/_mollie_gateway_help_theme.html.twig.`
