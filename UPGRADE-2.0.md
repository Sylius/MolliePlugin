...
| `bit_bag.sylius_mollie_plugin.action.state_machine.transition.processing_state_machine_transition`        | `sylius_mollie.payum.action.state_machine.transition.subscription_processing`         |
| `bit_bag.sylius_mollie_plugin.action.state_machine.transition.state_machine_transition`                   | `sylius_mollie.payum.action.state_machine.transition.subscription`                    |
