...
| `sylius_mollie_plugin.payum_action.refund`                                                                | `sylius_mollie.payum.action.refund`                                                       |
| `sylius_mollie_plugin.payum_action.refund_order`                                                          | `sylius_mollie.payum.action.refund_order`                                                 |
...
| `sylius_mollie_plugin.payum_action.api.create_customer`                                                   | `sylius_mollie.payum.action.api.create_customer`                                          |
| `sylius_mollie_plugin.action.convert_mollie_payment`                                                      | `sylius_mollie.payum.action.convert_mollie_payment`                                       |
| `sylius_mollie_plugin.action.convert_mollie_subscription_payment`                                         | `sylius_mollie.payum.action.convert_mollie_subscription_payment`                          |
| `sylius_mollie_plugin.payum_action.state_machine.status_recurring_subscription`                           | `sylius_mollie.payum.action.state_machine.status_recurring_subscription`                  |
...
| `Sylius\MolliePlugin\Applicator\UnitsPromotionAdjustmentsApplicatorInterface`                        | `sylius_mollie.applicator.units_promotion_adjustments`                                    |
| `Sylius\MolliePlugin\Calculator\CalculateTaxAmountInterface`                                         | `sylius_mollie.calculator.calculate_tax_amount`                                           |
| `Sylius\MolliePlugin\Context\Admin\AdminUserContextInterface`                                        | `sylius_mollie.context.admin.admin_user`                                                  |
| `Sylius\MolliePlugin\Controller\Action\Shop\PaymentFeeCalculateActionInterface`                      | `sylius_mollie.controller.shop.payment_fee_calculate`                                     |
...
| `Sylius\MolliePlugin\Applicator\Order\OrderVouchersApplicatorInterface`                              | `sylius_mollie.applicator.order.order_vouchers`                                           |
| `Sylius\MolliePlugin\Documentation\DocumentationLinksInterface`                                      | `sylius_mollie.documentation.documentation_links`                                         |
...
| `Sylius\MolliePlugin\Factory\ApiCustomerFactoryInterface`                                            | `sylius_mollie.factory.api_customer`                                                      |
...
| `Sylius\MolliePlugin\Checker\Refund\DuplicateRefundTheSameAmountCheckerInterface`                    | `sylius_mollie.checker.refund.duplicate_refund_the_same_amount`                           |
...
| `Sylius\MolliePlugin\Calculator\Refund\PaymentRefundCalculatorInterface`                             | `sylius_mollie.calculator.refund.payment`                                                 |
...
| `Sylius\MolliePlugin\Updater\Order\OrderVoucherAdjustmentUpdaterInterface`                           | `sylius_mollie.updater.order.order_voucher_adjustment`                                    |
...
| `Sylius\MolliePlugin\Checker\Voucher\ProductVoucherTypeCheckerInterface`                             | `sylius_mollie.checker.voucher.product_voucher_type`                                      |
| `Sylius\MolliePlugin\Action\CaptureActionInterface`                                                  | `sylius_mollie.payum.action.capture`                                                      |
| `Sylius\MolliePlugin\Action\StatusActionInterface`                                                   | `sylius_mollie.payum.action.status`                                                       |
